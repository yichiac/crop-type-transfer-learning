...
def copy_random_files(src_folder, all_folder, dest_folder, log_file, num_files):
    ...
    if num_files > len(selected_files):
        print('warning: number of files is larger than selected files')
...
# Call the function
copy_random_files(src_folder, all_folder, dest_folder, log_file, num_files)